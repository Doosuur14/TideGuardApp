...
//
////                    System.out.println("Comparing userCity=" + userCity + " with requested city=" + city);
//
...
//
//                    System.out.println("The user's city's latitude is" + latitude);
//                    System.out.println("The user's city's longitude is" + longitude);
//
//
